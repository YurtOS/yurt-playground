...
export async function updateLockHash(
  ...
  // Only the tree hash: the per-package hashes were subtrees of this very
  // tree, so they could never fail on their own, and keeping 29 constants in
  // lockstep cost more than the error message they bought.
